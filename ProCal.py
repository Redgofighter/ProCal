#ProCal by Redgofighter
from tkinter import*
import math
import parser
import tkinter.messagebox

#==============================TK inits and Settings===================================
root = Tk()
root.title("ProCal PY Editions")
...
btnSq = Button(calc, text="sqrt", width = 6, height=2,font=('arial',20, 'bold'), bd = 4, bg="powder blue", command = added_value.sqrt).grid(row = 1 ,column = 2, pady = 1)
...
btnMuti = Button(calc, text="*", width = 6, height=2,font=('arial',20, 'bold'), bd = 4, bg="powder blue", command = lambda: added_value.operation("muti")).grid(row = 3 ,column = 3, pady = 1)
...
btnEquels = Button(calc, text="=", width = 6, height=2,font=('arial',20, 'bold'), bd = 4, bg="powder blue", command = added_value.sum_of_total).grid(row = 5 ,column = 3, pady = 1)
#===================================================Scienftic Cal=================================================================

btnpi = Button(calc, text="TT", width = 6, height=2,font=('arial',20, 'bold'), bd = 4, bg="powder blue", command = added_value.pi).grid(row = 1 ,column = 4, pady = 1)
...
#==============================================================================================================================================
btn2TT = Button(calc, text="2TT", width = 6, height=2,font=('arial',20, 'bold'), bd = 4, bg="powder blue", command = added_value.tau).grid(row = 2 ,column = 4, pady = 1)
...
btndeg = Button(calc, text="deg", width = 6, height=2,font=('arial',20, 'bold'), bd = 4, bg="powder blue", command = added_value.deg).grid(row = 4 ,column = 5, pady = 1)
...
def iExit():
    iExit = tkinter.messagebox.askyesno("ProCal","Confirm if you want to exit")
    if iExit > 0:
        root.destroy()
        return
